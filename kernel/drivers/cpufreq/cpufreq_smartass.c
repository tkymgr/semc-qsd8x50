 ...
 */
#define DEFAULT_UP_MIN_FREQ 576000 //CONFIG_MSM_CPU_FREQ_ONDEMAND_MAX
 ...
 */
#define DEFAULT_SLEEP_MAX_FREQ 0 //CONFIG_MSM_CPU_FREQ_ONDEMAND_MIN
 ...
 */
#define DEFAULT_MAX_RAMP_UP 352000
